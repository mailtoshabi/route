                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt="" height="28"> <span class="logo-txt">Admin</span>
                                </a>
                            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'admin@route.sa')); ?>" id="input-username" placeholder="Enter User Name" name="email">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin_template\resources\views/auth/login.blade.php ENDPATH**/ ?>