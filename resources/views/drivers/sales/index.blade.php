...
@section('title') @lang($active==1?'translation.Active_deliveries':'translation.History_deliveries') @endsection
@section('css')
...
@slot('title') @lang($active==1?'translation.Active_deliveries':'translation.History_deliveries') @endslot
@endcomponent
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">@lang($active==1?'translation.Active_deliveries':'translation.History_deliveries') <span class="text-muted fw-normal ms-2">({{ $deliveries->count() }})</span></h5>
                         </div>
                     </div>
                         ...
                         <tbody>
                            @foreach ($deliveries as $delivery)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('driver.deliveries.show',encrypt($delivery->id)) }}" class="btn btn-primary btn-sm btn-rounded" >
                                            Details
                                        </a>
                                    </td>
                                </tr>
