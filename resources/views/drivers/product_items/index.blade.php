        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">@lang('translation.Product_Item_Manage_List') <span class="text-muted fw-normal ms-2">({{ $product_items->count() }})</span></h5>
                         </div>
                     </div>
                               ...
                               @endif
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{ route('branch.product_items.edit',encrypt($product_item->id))}}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                            {{-- <li><a href="{{ route('branch.product_items.destroy',encrypt($product_item->id))}}" class="dropdown-item"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li> --}}
                                            ...
                                            <form id="form_delete_{{ $loop->iteration }}" method="POST" action="{{ route('branch.product_items.destroy',encrypt($product_item->id))}}">
                                                @csrf
                                                <input type="hidden" name="_method" value="DELETE" />
                                            </form>
                                            <li><a class="dropdown-item" href="{{ route('branch.product_items.changeStatus',encrypt($product_item->id))}}"><i class="mdi mdi-cursor-pointer font-size-16 text-success me-1"></i> {{ $product_item->status?'Deactivate':'Activate'}}</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
