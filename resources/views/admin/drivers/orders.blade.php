...
@slot('title') @lang(request()->routeIs('admin.deliveries.orders.active')?'translation.Active_deliveries':'translation.History_deliveries') @endslot
@endcomponent
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">@lang(request()->routeIs('admin.deliveries.orders.active')?'translation.Active_deliveries':'translation.History_deliveries') <span class="text-muted fw-normal ms-2">({{ $deliveries->count() }})</span></h5>
                         </div>
                     </div>
