...
!function ($) {
  ...
  CalendarPage.prototype.init = function () {
    ...
    @foreach ($planners as $planner )
        {
            title: '#{{ $planner->product_sale->invoice_no }}-{{ $planner->type==1 ? "Delivery" : "Pickup" }}',
            start: new Date({{ $planner->year }}, {{ $planner->month-1 }}, {{ $planner->day }}),
            className: '{{ $planner->type==1 ? "bg-success" : "bg-info" }}',
            allDay: false,
        },
    @endforeach
