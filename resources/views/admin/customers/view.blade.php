                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="mt-4 mt-xl-3">
                            <a href="javascript: void(0);" class="text-primary">Joined on {{ $customer->created_at->format('d-m-Y') }}</a>
                            ...
                            <h6 class="text-primary"><i class="bx bx-phone font-size-16 align-middle text-primary me-1"></i>{{ $customer->phone }}</h6>
                            <h6 class="text-success"><i class="bx bx-message font-size-16 align-middle text-success me-1"></i>{{ $customer->email }}</h6>
                                ...
                                <div class="col-md-6 offset-md-1 col-sm-9 col-8">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="product-1" role="tabpanel" aria-labelledby="product-1-tab">
                                            <div>
                                                <img src="https://place-hold.it/800x800?text={{ $customer->first_name }}&fontsize=40" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1 ms-4">
                                                <h5 class="mb-2 font-size-15 text-primary">{{ $review->seller->name }}</h5>
                                                <h5 class="text-muted font-size-15">{{ $review->seller->city }}</h5>
