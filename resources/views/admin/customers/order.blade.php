...
@section('title') @lang(request()->routeIs('admin.customers.order')?'translation.Active_orders':'translation.History_orders') @endsection
@section('css')
...
@slot('title') @lang(request()->routeIs('admin.customers.order')?'translation.Active_orders':'translation.History_orders') of {{ $customer->name }} @endslot
@endcomponent
        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             {{-- <h5 class="card-title">@lang(request()->routeIs('admin.customers.order')?'translation.Active_orders':'translation.History_orders') <span class="text-muted fw-normal ms-2">({{ $orders->total() }})</span></h5> --}}
                         </div>
                     </div>
                        ...
                        <thead class="table-light">
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td>
                                    <a class="text-primary"  href="{{ route('admin.customers.view',encrypt($order->product->branch->customer->id))}}" target="_blank">{{ $order->product->branch->customer->name }}, {{ $order->product->branch->customer->city }}</a>
                                </td>
                                <td>
