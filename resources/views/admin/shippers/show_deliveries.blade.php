                        ...
                        <table class="table align-middle table-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="m-0 text-right">{{ $delivery->deliverable->vatproduct . ' ' . Utility::CURRENCY_DISPLAY }}</h6>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td>
                                        <h5 class="m-0 text-right">{{ (($delivery->deliverable->priceproduct) + ($delivery->deliverable->vatproduct)) . ' ' . Utility::CURRENCY_DISPLAY }}</h5>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
